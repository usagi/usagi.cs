...
namespace usagi.Quantity.GeoLocation
{
    ...
    , IFromGeoCoordinate
  {
    ...
    /// </summary>
    /// <remarks>
    /// 必要なら <see cref="usagi.CivilEngineering.LonLatHelper.DistanceTo(ILonLatGettable, ILonLatGettable, CivilEngineering.LonLatHelper.LonLatDistanceAlgorithm, CivilEngineering.Planet.IGeometricalSpecificationGettable)"/> を使うと良い
    /// </remarks>
    ...
    /// 必要なら <see cref="usagi.CivilEngineering.LonLatHelper.NearlyEqualsTo(ILonLatGettable, ILonLatGettable, Length, CivilEngineering.LonLatHelper.LonLatDistanceAlgorithm, CivilEngineering.Planet.IGeometricalSpecificationGettable)"/> を使うと良い
    ...
    {
      return
        Longitude.NearlyEqualsTo( x.Longitude, lon_tolerance ?? PlaneAngle.Second )
        && Latitude.NearlyEqualsTo( x.Latitude, lat_tolerance ?? PlaneAngle.Second )
        ;
    }
