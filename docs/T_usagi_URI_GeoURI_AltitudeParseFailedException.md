# GeoURI.AltitudeParseFailedException クラス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 

高度の認識に失敗したら飛ぶ例外


## 継承階層
<a href="http://msdn2.microsoft.com/ja-jp/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_usagi_URI_GeoURI_GeoURIException.md">usagi.URI.GeoURI.GeoURIException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usagi.URI.GeoURI.AltitudeParseFailedException<br /><strong>名前空間:</strong>
...
**C#**<br />
``` C#
public class AltitudeParseFailedException : GeoURI.GeoURIException
```

GeoURI.AltitudeParseFailedException 型は下記のメンバーを公開します。


## コンストラクター
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Public メソッド](media/pubmethod.gif "Public メソッド")</td><td><a href="M_usagi_URI_GeoURI_AltitudeParseFailedException__ctor.md">GeoURI.AltitudeParseFailedException</a></td><td>GeoURI.AltitudeParseFailedExceptionクラスの新しいインスタンスを初期化します</td></tr></table>&nbsp;
<a href="#geouri.altitudeparsefailedexception-クラス">トップ</a>
