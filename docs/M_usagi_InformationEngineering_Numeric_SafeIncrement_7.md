# Numeric.SafeIncrement メソッド (Single)<div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 
...
**C#**<br />
``` C#
public static float SafeIncrement(
	float a
)
```
...
#### 戻り値
型: <a href="http://msdn2.microsoft.com/ja-jp/library/3www918f" target="_blank">Single</a><br />元の値 + 1
