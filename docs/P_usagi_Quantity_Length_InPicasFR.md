# Length.InPicasFR プロパティ <div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 

フレンチ・パイカ, French Pica
...
**C#**<br />
``` C#
public double InPicasFR { get; set; }
```
