# WebMercator.AngleToPixel メソッド (PlaneAngle, PlaneAngle, Byte)<div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 
