# Numeric.ClampAdd メソッド (SByte, SByte)<div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 
...
#### パラメーター
&nbsp;<dl><dt>a</dt><dd>型: <a href="http://msdn2.microsoft.com/ja-jp/library/f71b253d" target="_blank">System.SByte</a><br />元の値</dd><dt>b</dt><dd>型: <a href="http://msdn2.microsoft.com/ja-jp/library/f71b253d" target="_blank">System.SByte</a><br />足す値</dd></dl>

#### 戻り値
型: <a href="http://msdn2.microsoft.com/ja-jp/library/f71b253d" target="_blank">SByte</a><br />加算結果
