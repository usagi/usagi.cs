# ILonLatSettable インターフェイス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 
...
ILonLatSettable 型は下記のメンバーを公開します。
...
経度を設定</td></tr></table>&nbsp;
<a href="#ilonlatsettable-インターフェイス">トップ</a>
