# LonLat クラス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 
...
## 継承階層
<a href="http://msdn2.microsoft.com/ja-jp/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;usagi.Quantity.GeoLocation.LonLat<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_usagi_Quantity_GeoLocation_LonLatAlt.md">usagi.Quantity.GeoLocation.LonLatAlt</a><br /><strong>名前空間:</strong>
...
**C#**<br />
``` C#
public class LonLat : ILonLat, ILonLatGettable, 
	ILonLatSettable, IToGeoCoordinate, IFromGeoCoordinate
```

LonLat 型は下記のメンバーを公開します。
...
<a href="#lonlat-クラス">トップ</a>

## プロパティ
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Public プロパティ](media/pubproperty.gif "Public プロパティ")</td><td><a href="P_usagi_Quantity_GeoLocation_LonLat_Latitude.md">Latitude</a></td><td>
緯度</td></tr><tr><td>![Public プロパティ](media/pubproperty.gif "Public プロパティ")</td><td><a href="P_usagi_Quantity_GeoLocation_LonLat_Longitude.md">Longitude</a></td><td>
経度</td></tr></table>&nbsp;
<a href="#lonlat-クラス">トップ</a>
