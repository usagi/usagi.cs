# GeoURI.GeoURIException クラス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 
...
GeoURI.GeoURIException 型は下記のメンバーを公開します。


## コンストラクター
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Protected メソッド](media/protmethod.gif "Protected メソッド")</td><td><a href="M_usagi_URI_GeoURI_GeoURIException__ctor.md">GeoURI.GeoURIException</a></td><td>GeoURI.GeoURIExceptionクラスの新しいインスタンスを初期化します</td></tr></table>&nbsp;
<a href="#geouri.geouriexception-クラス">トップ</a>
