# LatitudeParseFailedException メソッド<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small><a href="T_usagi_URI_GeoURI_LatitudeParseFailedException.md">GeoURI.LatitudeParseFailedException</a> 型は下記のメンバーを公開します。
...
<a href="#latitudeparsefailedexception-メソッド">トップ</a>
