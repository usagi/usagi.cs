...
## 継承階層
<a href="http://msdn2.microsoft.com/ja-jp/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/z3h75xk6" target="_blank">System.SystemException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/sxfw54a9" target="_blank">System.ArithmeticException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/41ktf3wy" target="_blank">System.OverflowException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usagi.InformationEngineering.Numeric.OverflowException<br /><strong>名前空間:</strong>
...
**C#**<br />
``` C#
public class OverflowException : OverflowException, 
	Numeric.INumericException
```

Numeric.OverflowException 型は下記のメンバーを公開します。


## コンストラクター
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Public メソッド](media/pubmethod.gif "Public メソッド")</td><td><a href="M_usagi_InformationEngineering_Numeric_OverflowException__ctor.md">Numeric.OverflowException(Object)</a></td><td>
発生原因の値についてメッセージを生成するコンストラクター</td></tr><tr><td>![Public メソッド](media/pubmethod.gif "Public メソッド")</td><td><a href="M_usagi_InformationEngineering_Numeric_OverflowException__ctor_1.md">Numeric.OverflowException(Object, Object)</a></td><td>
二項演算等で発生原因の値が2つある場合に それらの値からメッセージを生成するコンストラクター</td></tr></table>&nbsp;
<a href="#numeric.overflowexception-クラス">トップ</a>
...
## 解説
<a href="T_usagi_InformationEngineering_Numeric_UnderflowException.md">Numeric.UnderflowException</a> とはトモダチ。 

<a href="T_usagi_InformationEngineering_Numeric_UnderflowException.md">Numeric.UnderflowException</a> と等価な作り、名前空間、共通の基底型を持つと扱い易いので それを作る手前、オーバーフローについても <a href="http://msdn2.microsoft.com/ja-jp/library/41ktf3wy" target="_blank">OverflowException</a> も継承しつつ <a href="T_usagi_InformationEngineering_Numeric_UnderflowException.md">Numeric.UnderflowException</a> と対になるよう追加した。
