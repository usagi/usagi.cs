# GeoURIPatternIsNotMatchedException プロパティ<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small><a href="T_usagi_URI_GeoURI_GeoURIPatternIsNotMatchedException.md">GeoURI.GeoURIPatternIsNotMatchedException</a> 型は下記のメンバーを公開します。
...
<a href="#geouripatternisnotmatchedexception-プロパティ">トップ</a>
