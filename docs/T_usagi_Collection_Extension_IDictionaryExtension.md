...
## 継承階層
<a href="http://msdn2.microsoft.com/ja-jp/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;usagi.Collection.Extension.IDictionaryExtension<br /><strong>名前空間:</strong>
...
IDictionaryExtension 型は下記のメンバーを公開します。
...
<a href="#idictionaryextension-クラス">トップ</a>
