# Length.InMilesMetric プロパティ <div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 
...
**C#**<br />
``` C#
public double InMilesMetric { get; set; }
```
