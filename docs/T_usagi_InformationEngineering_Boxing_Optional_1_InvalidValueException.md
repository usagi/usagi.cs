...
## コンストラクター
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Public メソッド](media/pubmethod.gif "Public メソッド")</td><td><a href="M_usagi_InformationEngineering_Boxing_Optional_1_InvalidValueException__ctor.md">Optional(T).InvalidValueException</a></td><td>
生成</td></tr></table>&nbsp;
