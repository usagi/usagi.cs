# Optional(*T*) メソッド<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small><a href="T_usagi_Boxing_Optional_1.md">Optional(T)</a> ジェネリック型は下記のメンバーを公開します。
