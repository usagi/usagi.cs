# Numeric.UnderflowException クラス
...
Numeric.UnderflowException 型は下記のメンバーを公開します。
...
<a href="#numeric.underflowexception-クラス">トップ</a>
...
## 解説
<a href="T_usagi_InformationEngineering_Numeric_OverflowException.md">Numeric.OverflowException</a> とはトモダチ。 

<a href="http://msdn2.microsoft.com/ja-jp/library/41ktf3wy" target="_blank">OverflowException</a> はアンダーフローも扱うが、 例外処理としてアンダーフローかオーバーフローか判断できない不便さがあるから作った。
