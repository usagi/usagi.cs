# NumericExtension.ToSNorm メソッド (SByte, Double, Double, Double)<div style="font-size:30%"><a href="https://github.com/usagi/usagi.cs/blob/master/docs/Home.md">≪Back to Home</a></div> 
...
public static double ToSNorm(
	...
	double domain_logical_ceil = 127,
