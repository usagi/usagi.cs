# IToGeoCoordinate メソッド<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small><a href="T_usagi_Quantity_GeoLocation_IToGeoCoordinate.md">IToGeoCoordinate</a> 型は下記のメンバーを公開します。
...
<a href="#itogeocoordinate-メソッド">トップ</a>
