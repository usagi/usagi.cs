# IAltitude インターフェイス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 
...
**C#**<br />
``` C#
public interface IAltitude : IAltitudeGettable, 
	IAltitudeSetttable
```

IAltitude 型は下記のメンバーを公開します。
...
<a href="#ialtitude-インターフェイス">トップ</a>
