# GeoURI.GeoURIPatternIsNotMatchedException クラス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 

GeoURI として認識できない場合に飛ばす例外


## 継承階層
<a href="http://msdn2.microsoft.com/ja-jp/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/ja-jp/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_usagi_URI_GeoURI_GeoURIException.md">usagi.URI.GeoURI.GeoURIException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usagi.URI.GeoURI.GeoURIPatternIsNotMatchedException<br /><strong>名前空間:</strong>
...
**C#**<br />
``` C#
public class GeoURIPatternIsNotMatchedException : GeoURI.GeoURIException
```

GeoURI.GeoURIPatternIsNotMatchedException 型は下記のメンバーを公開します。


## コンストラクター
&nbsp;<table><tr><th></th><th>名前</th><th>説明</th></tr><tr><td>![Public メソッド](media/pubmethod.gif "Public メソッド")</td><td><a href="M_usagi_URI_GeoURI_GeoURIPatternIsNotMatchedException__ctor.md">GeoURI.GeoURIPatternIsNotMatchedException</a></td><td>GeoURI.GeoURIPatternIsNotMatchedExceptionクラスの新しいインスタンスを初期化します</td></tr></table>&nbsp;
<a href="#geouri.geouripatternisnotmatchedexception-クラス">トップ</a>
