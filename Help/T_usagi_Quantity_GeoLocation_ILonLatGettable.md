# ILonLatGettable インターフェイス<small>[<<Back to Home](https://github.com/usagi/usagi.cs/blob/master/Help/Home.md)</small> 
...
ILonLatGettable 型は下記のメンバーを公開します。
...
経度を取得</td></tr></table>&nbsp;
<a href="#ilonlatgettable-インターフェイス">トップ</a>
